...
import { TrendingUp, TrendingDown, Landmark, Globe, Coins, Wheat, BarChartHorizontal, Paperclip } from "lucide-react";
...
const marketTabs = [
  { value: "forex", label: "Forex", icon: <Globe className="h-4 w-4" /> },
  { value: "shares", label: "Shares", icon: <Landmark className="h-4 w-4" /> },
  { value: "metals", label: "Metals", icon: <Coins className="h-4 w-4" /> },
  { value: "commodities", label: "Commodities", icon: <Wheat className="h-4 w-4" /> },
  { value: "indices", label: "Indices", icon: <BarChartHorizontal className="h-4 w-4" /> },
  { value: "crypto", label: "Digital Currencies", icon: <Coins className="h-4 w-4" /> },
  { value: "bonds", label: "Bonds", icon: <Paperclip className="h-4 w-4" /> },
  { value: "etfs", label: "ETFs", icon: <Paperclip className="h-4 w-4" /> },
];
